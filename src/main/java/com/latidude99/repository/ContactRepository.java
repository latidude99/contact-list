...
public interface ContactRepository extends JpaRepository<Contact, Long> {
     ...
     */
    List<Contact> findByUserIdAndCreatedBetween(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, Pageable pageable);

    List<Contact> findByUserIdAndCreatedBetweenAndFirstNameIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String firstName, Pageable pageable);

    List<Contact> findByUserIdAndCreatedBetweenAndLastNameIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String lastName, Pageable pageable);

    List<Contact> findByUserIdAndCreatedBetweenAndPhoneIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String phone, Pageable pageable);

    List<Contact> findByUserIdAndCreatedBetweenAndEmailIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String email, Pageable pageable);

    List<Contact> findByUserIdAndCreatedBetweenAndStreetIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String street, Pageable pageable);

    List<Contact> findByUserIdAndCreatedBetweenAndPostcodeIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String postcode, Pageable pageable);

    List<Contact> findByUserIdAndCreatedBetweenAndCityIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String city, Pageable pageable);

    List<Contact> findByUserIdAndCreatedBetweenAndCountryIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String city, Pageable pageable);

    List<Contact> findByUserIdAndCreatedBetweenAndDescriptionIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String description, Pageable pageable);

    List<Contact> findByUserIdAndUpdatedBetweenAndFirstNameIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String firstName, Pageable pageable);

    List<Contact> findByUserIdAndUpdatedBetweenAndLastNameIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String lastName, Pageable pageable);

    List<Contact> findByUserIdAndUpdatedBetweenAndPhoneIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String phone, Pageable pageable);

    List<Contact> findByUserIdAndUpdatedBetweenAndEmailIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String email, Pageable pageable);

    List<Contact> findByUserIdAndUpdatedBetweenAndStreetIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String street, Pageable pageable);

    List<Contact> findByUserIdAndUpdatedBetweenAndPostcodeIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String postcode, Pageable pageable);

    List<Contact> findByUserIdAndUpdatedBetweenAndCityIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String city, Pageable pageable);

    List<Contact> findByUserIdAndUpdatedBetweenAndCountryIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String city, Pageable pageable);

    List<Contact> findByUserIdAndUpdatedBetweenAndDescriptionIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String description, Pageable pageable);


    List<Contact> findByUserIdAndCreatedBetweenAndFirstNameIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String firstName);

    List<Contact> findByUserIdAndCreatedBetweenAndLastNameIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String lastName);

    List<Contact> findByUserIdAndCreatedBetweenAndPhoneIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String phone);

    List<Contact> findByUserIdAndCreatedBetweenAndEmailIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String email);

    List<Contact> findByUserIdAndCreatedBetweenAndStreetIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String street);

    List<Contact> findByUserIdAndCreatedBetweenAndPostcodeIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String postcode);

    List<Contact> findByUserIdAndCreatedBetweenAndCityIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String city);

    List<Contact> findByUserIdAndCreatedBetweenAndCountryIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String city);

    List<Contact> findByUserIdAndCreatedBetweenAndDescriptionIgnoreCaseContaining(
            Long userId, ZonedDateTime dateStart, ZonedDateTime dateEnd, String description);
